...
<form>
<small>Diese Seite verwendet Websocket KODI <input id="WEBSOCKET_KODI" name="WEBSOCKET_KODI" class="inputws" value="ws:192.168.1.112:9090/jsonrpc" size="30"/>, also eine Adresse <u>im lokalen Netz!</u> Falls nötig ändern. Und <input id="WEBSOCKET_TEMP" name="WEBSOCKET_TEMP" class="inputws" value="ws:192.168.1.109:8080/temp" size="27"/> steht für den Temperatursensor (z.B. CPU im Raspberry B). Diese Einstellungen werden oben an die Adresszeile angefügt, so dass sie zur Wiederverwendung gleich mit im Lesezeichen landen. <i>Automatisch wird auch die Jahreszahl<input id="Jahr" type="hidden" name="JAHR" value="xxxx"/> angefügt, weil sich alles weiterentwickelt und ältere Lesezeichen später möglicherweise was ganz anderes schalten könnten.</i>Jetzt aber endlich <input type="submit" value="Websocket verbinden (connect)"/>. <span id="STATUS">DISCONNECTED</span></small>
</form>
 <hr/>
</div>
